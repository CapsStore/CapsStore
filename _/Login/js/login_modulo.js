...
// Función para redireccionar al usuario después de un inicio de sesión exitoso
function redireccionarUsuario() {
  // Aquí puedes especificar la URL de tu página principal
  const paginaPrincipalURL = "http://127.0.0.1:5501/index.html";
